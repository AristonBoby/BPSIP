<div class="card card-primary card-outline">
        ...
        <div class="card-body row">
            ...
            <div class="form-group col-lg-12 col-md-12 col-sm-12 row" >
                ...
                <div class="col-sm-8">
                    <select class="form-control @error('jenisPengujian') is-invalid @enderror" wire:model.live="jenisPengujian">
                        <option value="">--Pilih Salah Satu--</option>
                        @foreach ( $query as $data)
                            <option value="{{ $data->id }}" >{{ $data->jenis_pengujian }}</option>
                        @endforeach
                    </select>
                     @error('jenisPengujian') <span class=" text-red">{{ $message }}</span> @enderror
                </div>
            </div>
            ...
            <div class="form-group col-lg-12 col-md-12 col-sm-12 row" >
                ...
                <div class="col-sm-8">
                    <select class="form-control @error('analisa') is-invalid @enderror" wire:model='analisa'>
                        <option value="">--Pilih Salah Satu---</option>
                        @foreach ( $analisaSampel as $data)
                        <option value="{{ $data->id }}" >{{ $data->jenis_analisa }}</option>
                        @endforeach
                    </select>
                     @error('analisa') <span class=" text-red">{{ $message }}</span> @enderror
                </div>
            </div>
            ...
            <div class="form-group col-lg-12 col-md-12 col-sm-12 row" >
                ...
                <div class="col-sm-8">
                    <input type="text" wire:model='itemPengujian' class="form-control rounded-0  @error('analisa') is-invalid @enderror" placeholder="Jenis Pengujian Sampel">
                     @error('analisa') <span class=" text-red">{{ $message }}</span> @enderror
                </div>
            </div>
            ...
            <div class="form-group col-lg-12 col-md-12 col-sm-12 row" >
                ...
                <div class="col-sm-8">
                    <input type="text" id="" wire:model.defer='biaya' class="form-control rounded-0  @error('biaya') is-invalid @enderror" placeholder="Jenis Pengujian Sampel">
                     @error('biaya') <span class=" text-red">{{ $message }}</span> @enderror
                </div>
            </div>
