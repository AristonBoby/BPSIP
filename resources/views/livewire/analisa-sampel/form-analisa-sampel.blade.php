<div class="card card-primary card-outline">
        <div class="card-header">
            <h5 class="card-title"><b>Form</b> Analisa Sampel</h5>
        </div>
        ...
        <div class="card-body row">
            ...
            <div class="form-group col-lg-12 col-md-12 col-sm-12 row" style="margin-bottom:-5px;">
                ...
                <div class="col-sm-8">
                    <select type="text" wire:model.defer='varNomor_Surat' class="form-control rounded-0  @error('varNomor_Surat') is-invalid @enderror">
                        <option>Tanah</option>
                    </select>
