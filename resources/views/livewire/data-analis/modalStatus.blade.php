        ...
        <div class="modal-body row" wire:loading.hide>
            <form class="form-horizontal col-md-12" wire:submit='updatePemerikasaan'>
                <div class="form-group col-md-12 col-sm-12 col-lg-12 row">
                    <label class="control-label col-md-5 ">Update Status Pemeriksaan</label>
                    <div class="col-md-7">
                        <select class="form-control form-control" wire:model='updateStatus'>
                            ...
                            <option value="4">Sampel selesai diperiksa</option>
                            <option value="5">Sampel ditolak</option>
                        </select>
                    </div>
                </div>
